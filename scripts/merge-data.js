...
const FISHING_CSV  = path.join(__dirname, '..', 'fishing_data.csv');
const CONDITION_CSV = path.join(__dirname, '..', 'fishing_condition_db.csv');
const OUTPUT_CSV   = path.join(__dirname, '..', 'fishing_integrated.csv');
